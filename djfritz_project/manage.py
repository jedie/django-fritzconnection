...
def main(argv):
    os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'djfritz_project.settings.local')

    if '--version' not in argv:
        print(f'django-fritzconnection v{__version__} (Django v{django_version})', file=sys.stderr)
